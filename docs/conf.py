...
from minizinc_version import mzn_version, mzn_release
...
exclude_patterns = ["_build", "Thumbs.db", ".DS_Store", "*.toc.rst"]
...
""",
    ...
    #
    # 'preamble': '',
    "preamble": r"\usepackage{mznstyle}",
...
man_pages = [(master_doc, "minizinc", "MiniZinc Documentation", [author], 1)]
